...
const sendEmailForApi = async (email, subject , doctor_name , doctor_speci , date) => {
    try {
        ...
        await transporter.sendMail({
            ...
            text: text,
            html : `
            <h2>You have booked an appointment with the doctor : </h2>
...
module.exports = {sendEmailForApi};